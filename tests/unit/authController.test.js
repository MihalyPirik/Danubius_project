    ...
    describe('AuthController', () => {
        describe('POST /api/auth/registration', () => {
            describe('should user registration data and check it', () => {
                it('should handle login with correct credentials and return 201', async () => {
                    const response = await supertest(app).post('/api/auth/registration').send({
                        name: "misi",
                        email: "misi3@misi.hu",
                        password: "12345678"
                    });
                ...
                it('should handle login with incorrect credentials and return 400', async () => {
                    const response = await supertest(app).post('/api/auth/registration').send({
                        email: "misi3@misi.hu",
                        password: "12345678"
                    });
